<div class="flex gap-4">
  ...
  <div class="w-[256px] h-[130px] bg-white p-4 shadow-[0_0_18px_-4px_rgba(0,0,0,0.25)]">
    <p class="text-l font-bold text-black">Total Messages</p>
    <p class="text-3xl font-bold text-black my-2" id="totalMessages">0</p>
    <p class="text-sm font-thin text-black">All time</p>
  </div>
  <div class="w-[256px] h-[130px] bg-white p-4 shadow-[0_0_18px_-4px_rgba(0,0,0,0.25)]">
    <p class="text-l font-bold text-black">Unread Messages</p>
    <p class="text-3xl font-bold text-black my-2" id="unreadMessages">0</p>
    <p class="text-sm font-thin text-black">Need attention</p>
  </div>
  <div class="w-[256px] h-[130px] bg-white p-4 shadow-[0_0_18px_-4px_rgba(0,0,0,0.25)]">
    <p class="text-l font-bold text-black">Read Messages</p>
    <p class="text-3xl font-bold text-black my-2" id="readMessages">0</p>
    <p class="text-sm font-thin text-black">Processed</p>
  </div>
</div>
...
<div class="w-full bg-white flex flex-col items-start p-8 shadow-[0_0_18.2px_-4px_rgba(0,0,0,0.25)] mt-8">
  <div class="w-full flex justify-between mb-8">
    <p class="text-2xl font-bold">Contact Messages</p>
...
<!-- VIEW MESSAGE MODAL -->
<div id="viewMessageModal" class="hidden fixed inset-0 bg-white/20 backdrop-blur-md z-50">
  <div class="flex items-center justify-center h-full">
    <div class="bg-white p-6 rounded shadow-lg w-[700px] max-h-[80vh] overflow-y-auto">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold text-gray-900">Contact Message Details</h2>
        <button id="closeViewMessageModal" class="text-gray-500 hover:text-gray-700">
      ...
      <div class="flex justify-end gap-3 mt-6">
        <button id="closeViewMessageBtn" class="px-4 py-2 border rounded hover:bg-gray-100 cursor-pointer">Close</button>
      </div>
    </div>
  </div>
</div>
