    ...
    <div class="space-y-6">
      ...
      <?php else: ?>
        ...
        <div class="text-center py-12">
          ...
          <h3 class="text-xl font-semibold text-gray-700 mb-2">Privacy Policy Coming Soon</h3>
          <p class="text-gray-500 mb-6">
            We're working on our privacy policy. Please check back later.
          </p>
